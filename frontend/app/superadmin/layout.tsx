...
export default function SuperAdminLayout({
  ...
  const menuItems = [
    ...
    { icon: Users, label: "Admins", href: "/superadmin/admins" },
    { icon: GraduationCap, label: "Students", href: "/superadmin/students" },
    { icon: FileText, label: "Documents", href: "/superadmin/documents" },
    { icon: LogIn, label: "Audit Logs", href: "/superadmin/audit" },
    { icon: BarChart3, label: "Stats", href: "/superadmin/stats" },
  ]
            ...
            <div className="relative">
              ...
              >
                <UserAvatar
                  ...
                  className="h-10 w-10 bg-gradient-to-br from-primary to-primary/60"
                  fallbackClassName="from-primary to-primary/60"
                  fallbackText={user?.fullName?.charAt(0).toUpperCase() || "SA"}
                />
                <div className="text-left">
                  <p className="text-sm font-medium text-foreground">{user?.fullName || "SuperAdmin"}</p>
